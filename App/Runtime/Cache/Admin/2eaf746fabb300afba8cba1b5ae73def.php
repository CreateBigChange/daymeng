...
td{
 ...
 if($items["repay_check"]==1){ echo " checked"; } ?>		 />1
		 ...
		 <span style="margin-left:30px;color:#ea544a">(0表示未通过审核,1表示通过审核)</span></td></tr><tr><tr><td colspan="2" style="text-align:center"><input type="submit" value="确认通过审核" /></td></tr><tr><td colspan="3" class="page"><?php echo ($page); ?></td></tr></form><?php endforeach; endif; ?></table>